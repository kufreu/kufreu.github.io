  ...
  distdir_s2 = function (input, origin, prefix = "") {
    ...
    # calculating direction on a sphere 
    # https://software.intel.com/content/www/us/en/develop/blogs/calculating-a-bearing-between-points-in-location-aware-apps.html
